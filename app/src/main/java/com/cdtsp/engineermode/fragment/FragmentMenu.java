...
import com.cdtsp.engineermode.view.MenuButton;
...
public class FragmentMenu extends Fragment {
    ...
    /**
     * Switch Fragment content list
     * @param pos
     */
    public void switchContentList(int pos) {
        if (pos == mCurPos) {
            return;
        }
        if (mCurPos != -1) {
        ...
        if (mCallback != null) {
            mCallback.onSwitchContent(pos);
        }
    }

    public interface Callback {
        void onSwitchContent(int pos);
    }
}
