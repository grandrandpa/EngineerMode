...
public class ItemGroup extends LinearLayout {
    ...
    public ItemGroup(Context context, @Nullable AttributeSet attrs) {
        ...
        //获取属性
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ItemGroup);
        String titleStr = ta.getString(R.styleable.ItemGroup_title);
        int textSize = ta.getDimensionPixelSize(R.styleable.ItemGroup_textSize, 20);
        int optArrayResId = ta.getResourceId(R.styleable.ItemGroup_optArray, -1);
