...
interface IRadioManager {
	...
	void playPrev();
	void store(); 
	void playIndexInPresetList(int index);
	void deletePresetOfIndex(int index);
	void togglePreset();
	List<RadioStation> getPresetsList();

	int getCurrentRadioBand();

	void playIndexInList(int index);
	...
	List<RadioStation> getPreScanned();
